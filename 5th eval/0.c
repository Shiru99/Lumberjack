...
void neibhour()
{
  ...
  { 
...

   {
    ...
    // timemax = 5000
    {
      treeDetails[i].starProfit = ((float)(p*p+2*p*p*q)/(3*q*q*q) );
    }
...
{
 {
  ...
  if(arrangment[371][431]->weight != 0 ){fairyTale = 22;}
    ...
    // }
    // else if(fairyTale==28)
    // {
    // for( s2 = 0;s2<400;s2++){printf("move up\n");}
    // for( s1 = 0;s1<20;s1++){printf("move right\n");}
    // }
    // else if(fairyTale==27)
    // {
    // for( s2 = 0;s2<650;s2++){printf("move up\n");}
    // for( s1 = 0;s1<400;s1++){printf("move right\n");}
    // }
    // else if(fairyTale==26)
    // {
    // for( s2 = 0;s2<0;s2++){printf("move up\n");}
    // for( s1 = 0;s1<300;s1++){printf("move right\n");}
    // }
    // else if(fairyTale==24)
    // {
    // for( s2 = 0;s2<132;s2++){printf("move up\n");}
    // for( s1 = 0;s1<132;s1++){printf("move right\n");}
    // }
    // else if(fairyTale==23)
    // {
    // for( s2 = 0;s2<166;s2++){printf("move up\n");}
    // for( s1 = 0;s1<166;s1++){printf("move right\n");}
    // }
    // else if(fairyTale==22)
    // { 
    // for( s2 = 0;s2<400;s2++){printf("move up\n");}
    // for( s1 = 0;s1<20;s1++){printf("move right\n");}
    // }
    ...
    for( s2 = 0;s2<254;s2++){printf("move up\n");}
    for( s1 = 0;s1<143;s1++){printf("move right\n");}
